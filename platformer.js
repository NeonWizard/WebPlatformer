(function() { // module pattern
	...
	function setupEntity(obj) {
		// Tiled now does obj.properties dumb. Instead of obj mapping key=>value, it's an array of objects
		// with name, value, and type properties.
		var tmp = obj.properties || [];
		obj.properties = {};
		for (var prop of tmp) {
	...
	get("levels/level2.json", function(req) {
